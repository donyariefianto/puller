            ...
            try {
              if (i.status == 1) {
                ...
                if (insert.insertedCount > 0) {
                  await Processing.Create_LogsV2(23,Number(i.externalDataId),'scheduler','scheduler_mongodb','fivemin',now,`Generate five minutes Record Vehicle Cam ${i.cameraIndexCode} User 23 successfully`,t1,t0);
                  ...
                  await Processing.Create_LogsV2(23,Number(i.externalDataId),'scheduler','scheduler_mongodb','fivemin',now,`Generate five minutes Record Vehicle Cam ${i.cameraIndexCode} User 23 data null`,t1,t0);
